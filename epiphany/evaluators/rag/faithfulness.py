from epiphany.evaluators.rag.metric import Metric
from epiphany.evaluators.rag.open_ai_completion import OpenAICompletion
...
class FaithfulnessFailure(Metric):
    ...
    def compute(faith_eval):
        ...
        """
        is_faithfulness_failure = FaithfulnessFailure.verdict_to_int(faith_eval["verdict"])
