...
class HumanAgent:
    ...
    PROMPT = PromptTemplate(
        """
        You are a person that knows only information about the given content. Given the context information, answer the received message. If you can't answer the question, please mention that.
        Message: {message}
        Context: {context_str}
        Answer:
        """
