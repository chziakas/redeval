from ...llms.open_ai_completion import OpenAICompletion
...
class OpenQuestionGenerator:
    ...
    SYSTEM_MESSAGE = """
        You are an expert at generating open questions given the content of a text.
    """

    USER_MESSAGE_TEMPLATE = """
        Let's think step by step.
        1. Consider the text: {}.
        2. Generate {} open ended questions based on the content.
